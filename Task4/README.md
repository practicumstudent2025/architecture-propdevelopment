...
### Возможности мастер-скрипта
- **Автоматическая проверка** предварительных требований (Minikube, kubectl, OpenSSL)
- **Последовательное выполнение** всех этапов настройки
- **Проверка успешности** каждого этапа с остановкой при ошибках
- **Паузы между этапами** для лучшей читаемости процесса
- **Финальная проверка** результатов настройки
- **Подробная статистика** созданных ресурсов
...
### Логи мастер-скрипта
Мастер-скрипт выводит подробную информацию о каждом этапе:
- ✅ Успешное выполнение этапов
- ❌ Ошибки с остановкой выполнения
- 📊 Статистика созданных ресурсов
- 🔧 Полезные команды для проверки

### Преимущества мастер-скрипта
- **Быстрота** - один скрипт вместо четырех
- **Надежность** - проверка каждого этапа
- **Информативность** - подробные логи и статистика
